  ...
  <div class="navbar navbar-inverse">
    <div class="navbar-header" style="min-width:350px;">
      <ul class="nav navbar-nav visible-xs-block">
        <li style="float: left;margin-left: -49px;position: absolute;left: 66px;">
          <nuxt-link to="/" class="navbar-brand nuxt-link-active" style="padding-left:0px;">
            <img src="~/assets/images/logo.png" class="mr-1" style="display:inline-block;" />
            <span style="display:inline-block;">MY APP</span>
          </nuxt-link>
        </li>
        <li>
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        <li>
          <nuxt-link class="navbar-brand" style="padding-left:0px" to="/">
            <img src="~/assets/images/logo.png" style="display: inline-block;" class="mr-1" />
            <span style="display: inline-block;">ANYCAR</span>
          </nuxt-link>
          <div
            @click="toggleSidebar"
            style="display: inline-block;margin-top: 13px;margin-left: 120px;"
          >
      ...
      <div>
        <div style="list-style:none;float:right">
          <!-- <el-dropdown @command="changeLang" trigger="click" class="mr-4">
            <span class="el-dropdown-link" style="color:#fff">
              {{lang == 'vi' ? 'Tiếng việt' : 'English'}}<i class="el-icon-arrow-down el-icon--right"></i>
            </span>
            <el-dropdown-menu slot="dropdown" >
              <el-dropdown-item >{{lang != 'vi' ? 'Tiếng việt' : 'English'}}</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>-->
...
export default {
  ...
  mounted() {
    ...
    myBodyOBJ.onscroll = function(e) {
      _.forEach(document.querySelectorAll("table"), (o, i) => {
        var thead = document.querySelectorAll("thead")[i];
        var table = o ? o.getBoundingClientRect() : null;
        if (thead && table) {
          var top = table.top;
          if (top <= 0) {
